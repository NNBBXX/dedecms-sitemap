...
<m:top item='5_' name='HTML更新' notshowall='1' display='none' rank='sys_MakeHtml'>
  ...
  <m:item name='更新地图XML' link='makehtml_xmlpage.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新地图HTML' link='makehtml_htmlpage.php' rank='sys_MakeHtml' target='main' />
  <m:item name='生成百度自适配' link='makehtml_baiduzipage.php' rank='sys_MakeHtml' target='main' />
